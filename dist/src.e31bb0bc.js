...
},{"@babel/runtime/helpers/esm/objectSpread2":"../node_modules/@babel/runtime/helpers/esm/objectSpread2.js"}],"../../../../../Users/inthej/.config/yarn/global/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../../../Users/inthej/.config/yarn/global/node_modules/process/browser.js"}],"common/AppConstants.js":[function(require,module,exports) {
"use strict";
...
var AppConstants = {}; // Document

AppConstants.ENTER_KEY_CODE = 13;
...
var _AppConstants = _interopRequireDefault(require("./common/AppConstants"));
...
// DOM Reference
var myInput = (0, _jquery.default)('#myInput');
var addBtn = (0, _jquery.default)('.addBtn');
var todoList = (0, _jquery.default)('#todoList'); // Action Types

var ADD_TODO = 'ACC_TODO';
var CLOSE_TODO = 'CLOSE_TODO';
var TOGGLE_TODO = 'TOGGLE_TODO'; // Action Create Function
...
var closeTodo = function closeTodo(todoIdx) {
  return {
    type: CLOSE_TODO,
    todoIdx: todoIdx
  };
...
var toggleTodo = function toggleTodo(todoIdx) {
  return {
    type: TOGGLE_TODO,
    todoIdx: todoIdx
  };
    ...
    case CLOSE_TODO:
      return _objectSpread(_objectSpread({}, state), {}, {
        todos: state.todos.filter(function (todo) {
          return todo.idx !== action.todoIdx;
        })
      });
    ...
    case TOGGLE_TODO:
      return _objectSpread(_objectSpread({}, state), {}, {
        todos: state.todos.map(function (todo) {
          return todo.idx === action.todoIdx ? _objectSpread(_objectSpread({}, todo), {}, {
...
var render = function render() {
  ...
  state.todos.forEach(function (todo) {
    var itemId = "item-".concat(todo.idx);
    var closeBtnId = "close-".concat(todo.idx);
    var todoElementLi = "<li id=\"".concat(itemId, "\" ").concat(todo.checked ? 'class="checked"' : '', " >").concat(todo.text, "<span class=\"close\" id=\"").concat(closeBtnId, "\">x</span></li>");
    todoList.append(todoElementLi); // toggle event

    (0, _jquery.default)("#".concat(itemId)).on('click', function () {
      store.dispatch(toggleTodo(todo.idx));
    }); // close event

    (0, _jquery.default)("#".concat(closeBtnId)).on('click', function () {
...
myInput.on("keyup", function (key) {
  if (key.keyCode === _AppConstants.default.ENTER_KEY_CODE) {
    dispatchAddTodo();
  }
});

var dispatchAddTodo = function dispatchAddTodo() {
  var inputText = myInput.val();
  var isEmptyInput = inputText.length === 0;
...
},{"redux":"../node_modules/redux/es/redux.js","jquery":"../node_modules/jquery/dist/jquery.js","./common/AppConstants":"common/AppConstants.js"}],"../../../../../Users/inthej/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../Users/inthej/.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
